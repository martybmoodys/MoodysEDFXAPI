...
class EDFXEndpoints(EDFXClient):
    ...
    def SynchronousBatchMVP(self,EntityPayload:list[dict[str,str]], BatchSize:int,historyFrequency:str='monthly',startDate:str=None,
                            ...
                            includeDetailInput:bool = False, includeDetailModel:bool=False):
        """
    ...
    async def SynchronousBatchMVP_async(self, EntityPayload:list[dict[str,str]], BatchSize:int,semaphore:int=500, historyFrequency:str='monthly',
