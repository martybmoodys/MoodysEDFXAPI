...
class EDFXEndpoints(EDFXClient):
    ...
    def format_payload(self, entity_series:pd.Series):
    ...
    async def EDFXPD_Endpoint_async(self, entities:list[dict[str,str]]=None, startDate:str=None, endDate:str=None, historyFrequency:str='monthly',
                                    retries:int=15,asyncResponse:bool=False, asReported:bool=False, modelParameters:bool=False, includeDetailResult:bool=False,
                                    includeDetailInput:bool = False, includeDetailModel:bool=False, includeTermStructure: bool=True, processId:str=None,
                                    CreditEdge:bool=False, RiskCalc:bool=False, TradePayment:bool=False, timeout:float=10000):
            ...
            for _ in range(4): 
                ...
                async with session.post(url, headers=headers, json=params) as response:
                    ...
                    if 'entities' not in payload:
                        # logger error
                        logger.error(f"Server Response {payload}\n params for the failedentity are {params}")
    ...
    async def SynchronousBatchMVP_async(self,EntityPayload:list[dict[str,str]], BatchSize:int,historyFrequency:str='monthly',startDate:str=None,
                            endDate:str=None, asReported:bool=False, modelParameters:bool=False,includeDetailResult:bool=True,
                            includeDetailInput:bool = False, includeDetailModel:bool=False):
        """
